            ...
            echo '
                ...
                if(mysqli_num_rows($resultfeed) > 0){
                    ...
                    while($rowfeeds = mysqli_fetch_assoc($resultfeed)){
                            ...
                            echo '<li><a href="edit-feeds.php?CategoryName='.$categoryID.'&FeedsID='.(int)$rowfeeds['FeedsID'].'">'.stripslashes($rowfeeds['SubCategory']).'<img src="images/edit.ico" alt="edit"></a></li>';
                    } 
